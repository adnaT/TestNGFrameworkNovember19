...
public class LoginTest {
	...
	@Test(enabled= false, priority=2, description = "login test with incorrect username and incorrect password")
	public void loginTest1() throws InterruptedException{
		loginPage.doLogin(prop.getProperty("invalidusername"), prop.getProperty("invalidpassword"));
		//Thread.sleep(4000);
	}
	
	@Test(enabled= false, priority=3, description = "login test with correct username and incorrect password")
